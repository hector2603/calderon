...
class InsurancesControllerTest < ActionController::TestCase
  ...
  test "should create insurance" do
    assert_difference('Insurance.count') do
      post :create, insurance: { descripcion: @insurance.descripcion, nombre: @insurance.nombre, resumen: @insurance.resumen }
    end
  ...
  test "should update insurance" do
    patch :update, id: @insurance, insurance: { descripcion: @insurance.descripcion, nombre: @insurance.nombre, resumen: @insurance.resumen }
    assert_redirected_to insurance_path(assigns(:insurance))
  end
