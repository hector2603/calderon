...
class ContactosControllerTest < ActionController::TestCase
  ...
  test "should create contacto" do
    assert_difference('Contacto.count') do
      post :create, contacto: { asunto: @contacto.asunto, nombre: @contacto.nombre, numero: @contacto.numero, texto: @contacto.texto }
    end
  ...
  test "should update contacto" do
    patch :update, id: @contacto, contacto: { asunto: @contacto.asunto, nombre: @contacto.nombre, numero: @contacto.numero, texto: @contacto.texto }
    assert_redirected_to contacto_path(assigns(:contacto))
  end
